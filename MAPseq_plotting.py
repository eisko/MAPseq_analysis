...
def single_neuron_bar(df, neuron, figsize=(6.4, 0.5), label=None, ylim=[0,1],
                      ...
                      cmap=orange_cmp, col_order=None, ylog=False):
    """_summary_
    ...
    Args:
        ...
        ylog (boolean, optional): Whether to plot yaxis on log. Defaults to False.
    """
    ...
    plt.text(-2, (ylim[0]+ylim[1])/2, label, va="center_baseline", size=12)
